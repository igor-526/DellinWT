...
def register_handlers_reports_to_delete(dp: Dispatcher):
    dp.register_message_handler(delete, state=Reports.turnover_del_confirm, regexp="Удалить записи")
    dp.register_message_handler(menu, state=Reports.turnover_del_confirm, regexp="Меню")
    dp.register_message_handler(inval, state=Reports.turnover_del_confirm)
